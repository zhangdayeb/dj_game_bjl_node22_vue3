<template>
  <div
    class="bet-zone dragon7-zone first-row-zone"
    :class="{
      'active': hasActiveBet,
      'winning': isWinning,
      'losing': isLosing,
  ...
  >
    <div class="zone-header">
      <div class="zone-title">龙7</div>
      <div class="zone-odds">1:40</div>
    </div>
...
const handleBetClick = () => {
  ...
  if (success) {
    console.log('龙7投注成功:', bettingStore.selectedChip)
...
const animateClick = () => {
  const element = document.querySelector('.dragon7-zone')
  if (element) {
